...
<?php else: ?>
    ...
    <div class="chat">
        <div class="top">
            ...
            <div class="row">
                <div class="profilePictureAdmin" style="background-image: url('<?php echo $pathExtention;  echo $user["isAdmin"] == "on" ? $userProfilePicture : $adminProfilePicture; ?>')">
                </div>
                <div class="column">
                    <span>Chat met</span>
        ...
        <div class="center" id="chatWindow">
            ...
            <?php if ($messages) : ?>
                <?php foreach ($messages as $message) : ?>
                    <div class="row <?php echo $message["sender_id"] == $_SESSION["user_id"] ? "user" : "admin" ?>" data-messageid=<?php echo $message["id"]; ?>>
                        <div class="profilePicture"
                            style="background-image: url('<?php echo $pathExtention;  echo User::getUserById($pdo, $message["sender_id"])["isAdmin"] == "on" ? $adminProfilePicture : $userProfilePicture; ?>');">
                        </div>
        ...
        <div class="bottom">
            ...
            <div class="center" style="display: <?php echo Chat::getActiveChat($pdo, $_SESSION["user_id"]) ? "block" : "none"; ?>">
