                    ...
                    <div class="step">
                        <div class="text">
                            ...
                            <select name="steps[<?php echo $step["id"] ?>][label]" class="label">
                                <option value="Start" <?php if ($step["label"] == "Start") {echo "selected";
                                } ?>>Start</option>
                            ...
                            <input type="text" name="steps[<?php echo $step["id"] ?>][id]" value="<?php echo $step["id"] ?>" hidden>
                        </div>
                        <div class="icons">
                            <label for="delete[<?php echo $step["id"] ?>]"><i class="fa fa-trash"></i></label>
                            <input hidden type="submit" name="delete[<?php echo $step["id"] ?>]" id="delete[<?php echo $step["id"] ?>]">
                        </div>
                    </div>
